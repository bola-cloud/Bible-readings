...
class _Masba73a2lyState extends State<Masba73a2ly> {
  final List<Map<String, String>> _steps = const [
    ...
    },
    {
      ...
      'body': 'الكتاب المقدس، الترانيم، دفتر صغير للتدوين، وطلبات أو تأملات.'
    },
    {
      'title': '٤ - بداية بالصلاة الافتتاحية',
      'body': 'ابدأوا بصلاة قصيرة مثل "باسم الآب والابن والروح القدس" وطلب حضور الرب.'
    },
    {
      'title': '٥ - قراءة نص كتابي قصير',
      'body': 'اقرأوا آية أو فقرة قصيرة من الإنجيل أو حسب خطة القراءة العائلية.'
    },
    {
      'title': '٦ - ترنيمة أو مزمور',
      'body': 'غنّوا ترنيمة بسيطة أو اقرأوا مزمورًا يعرفه الجميع.'
    },
    {
      'title': '٧ - فكرة وتأمل بسيط',
      'body': 'تعليق قصير من الأب أو الأم أو أحد الأولاد عن معنى النص وسؤال تأملي.'
    },
    {
      'title': '٨ - وقت صلاة حرة',
      'body': 'كل فرد يصلّي من قلبه: شكر، طلبات، قرارات صغيرة للعيش بالمسيح.'
    },
    {
      'title': '٩ - الصلاة الختامية',
      'body': 'ختم الصلاة بصلاة محفوظة أو بركة عائلية قصيرة.'
    },
  ];
